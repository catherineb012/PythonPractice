...
print('You are ' + str(age) + ' years old')  #if you are displaying the result as a string then you have to turn 'age' from an intger to a string to make all the expressions strings
